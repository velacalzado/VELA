...
<head>
  ...
  <link rel="icon" href="vela-icon2.png" type="image/png">
  <style>
    :root {
      --rosa: #F8BBD0;
      --lila: #E1BEE7;
    ...
    .hero {
      height: 55vh;
      background: url('calzado.png') center/cover no-repeat;
      display: flex;
...
<body>
  ...
  <section id="productos" class="productos">
    ...
    <div class="grid">
      <!-- Producto 1 -->
      <div class="card">
        <img src="calzado.png" alt="Tenis deportivos">
        <h3>Tenis Urban</h3>
      ...
      <!-- Producto 2 -->
      <div class="card">
        <img src="calzado.png" alt="Botines">
      ...
      <!-- Producto 3 -->
      <div class="card">
        <img src="calzado.png" alt="Sandalias">
  ...
  <footer id="contacto">
    <img src="vela-text.png" alt="VELA">
